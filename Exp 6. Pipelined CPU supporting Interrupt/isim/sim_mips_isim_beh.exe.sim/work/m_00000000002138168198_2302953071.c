...
#endif
static const char *ng0 = "//Mac/Home/Arch/Exp 6. Pipelined CPU supporting Interrupt/sim_mips.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
...
{
	static char *pe[] = {(void *)Initial_29_0,(void *)Initial_52_1};
